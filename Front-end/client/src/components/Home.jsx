    ...
    return (
        <div className="w-[430px] h-[932px] bg-[#f8f8f8] overflow-hidden">
            <div className="relative w-[1269px] h-[1352px] top-[-312px] left-[-815px]">
                ...
                <img className="h-[41px] top-[705px] absolute w-[41px] left-[912px]" alt="Menu" src="menu.png" />
                <img
                ...
                <div className="absolute w-[164px] h-[146px] top-[906px] left-[846px]">
                    <div className="relative w-[162px] h-[146px] bg-white rounded-[10px] shadow-[4px_4px_4px_#00000040]">
                        <img className="absolute w-[55px] h-[55px] top-[38px] left-[54px]" alt="Bx box" src="bx-box.png" />
                ...
                <img className="absolute w-[61px] h-[53px] top-[693px] left-[1100px]" alt="Group" src="group-1000002322.png" />
            </div>
        </div>
    );
};