...
export const EstoqueHome = ({ className }) => {
  return (
    <div
      className={`relative w-[430px] h-[2129px] bg-[#f8f8f8] overflow-hidden overflow-y-scroll ${className}`}
    >
      ...
      <div className="absolute w-[430px] h-[1308px] top-[1111px] left-0">
        <img
          className="absolute w-[204px] h-[455px] top-[403px] left-[226px]"
          alt="Ellipse"
          src="ellipse-3.svg"
        />
        <img
          className="absolute w-[228px] h-[455px] top-0 left-0"
          alt="Ellipse"
          src="ellipse-4.svg"
        />
        <img
          className="absolute w-[373px] h-[512px] top-[21px] left-7"
          alt="Content"
          src="image.svg"
        />
